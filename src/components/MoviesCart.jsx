function MoviesCart({
  ...
  return (
    <div
      className="overflow-hidden h-[45vh] w-[165px] bg-cover bg-center rounded-xl hover:scale-110 duration-300 hover:cursor-pointer flex flex-col justify-between items-end"
      style={{
