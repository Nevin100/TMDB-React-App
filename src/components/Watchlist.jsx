      ...
      <div className="flex justify-center flex-wrap m-4">
        {genre.map((genreList, index) => {
          return (
            <div
              key={index}
              onClick={() => handleFilter(genreList)}
              className={
                currGenre == genreList
                  ? "flex justify-center h-[3rem] w-[9rem] rounded-xl bg-blue-400 text-white items-center mx-2"
                  : "flex justify-center h-[3rem] w-[9rem] rounded-xl bg-gray-400/50 text-white items-center mx-2"
              }
            >
              {genreList}
            </div>
            ...
            {watchlist
              ...
              .map((movieObj) => (
                ...
                >
                  ...
                  <td className="max-w-[250px] break-words">
                    {movieObj.overview}
                  </td>
